...
namespace VelascoGames.NodeGraphEditor
{
	public class RoomNodeSO : ScriptableObject
	{
		...
		/// <summary>
		/// Add childID to the node (returns true if node has been added, flase otherwise)
		/// </summary>
		...
		public bool IsChildRoomValid(string childID)
		{
			...
			//If this node already has a child with the childID return false
			...
			//If childis not a corridor and this node is not acorridor return false
			if (!roomNodeGraph.GetRoomNode(childID).roomNodeType.isCorridor && !roomNodeType.isCorridor)
			{
				return false;
			}
			...
			//If the child room is an entrance return false - the entrance must always abe the top level parent node
		...
		/// <summary>
		/// Add parentID to the node (returns true if node has been added, flase otherwise)
		/// </summary>
		...
		/// <summary>
		/// Remove childID from the node (returns true if the node has been remove, false otherwise)
		/// </summary>
		...
		public bool RemoveParentRoomNodeIDFromRoomNode(string parentID)
		{
			...
			{
				parentRoomNodeIDList.Contains(parentID);
				return true;
			}
			return false;
		}
